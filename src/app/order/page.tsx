...
export default function OrderPage() {
  ...
  return (
    <div className="relative px-4 pb-24">
      ...
      <Button className="h-12 w-full bg-[var(--color-pink-400)]">
        <div className="text-body-M-semibold ">주문하기</div>
        <div className="flex h-6 w-6 cursor-pointer items-center justify-center rounded-full text-[var(--color-pink-400)] bg-[#ffffff]">
          {totalCount()}
        </div>
      </Button>
    </div>
